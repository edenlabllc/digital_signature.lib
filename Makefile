...
priv/digital_signature_lib_nif.so: src/digital_signature_lib_nif.c
	cc -Wall -Wextra -Wno-unused-parameter -Wl,-undefined -Wl,dynamic_lookup -shared -fPIC -I$(ERL_INCLUDE_PATH) src/digital_signature_lib_nif.c -o priv/digital_signature_lib_nif.so
